...
var CrosswordBoard = /** @class */ (function () {
    ...
    CrosswordBoard.prototype.measure = function () {
        ...
        this.upperLeft = new Point(Math.min.apply(Math, xKeys), Math.min.apply(Math, yKeys));
        this.lowerRight = new Point(Math.max.apply(Math, xKeys), Math.max.apply(Math, yKeys));
    ...
    CrosswordBoard.prototype.writeLetter = function (letter, position) {
        ...
        if (currentValue) {
            ...
            if (currentValue !== letter &&
                currentValue !== letter.overlappingLetter &&
                !currentValue.overlap(letter)) {
