...
var CrosswordBoard = /** @class */ (function () {
    ...
    CrosswordBoard.prototype.isAcross = function (letter, currentPosition) {
        ...
        if (letter.wordNextLetter && (nextLateralLetter === letter.wordNextLetter || (nextLateralLetter === null || nextLateralLetter === void 0 ? void 0 : nextLateralLetter.overlappingLetter) === letter.wordNextLetter)) {
            return true;
        }
        return false;
    };
