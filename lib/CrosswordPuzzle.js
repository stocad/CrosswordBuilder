...
var CrosswordPuzzle = /** @class */ (function () {
    ...
    CrosswordPuzzle.prototype.width = function () {
        return this.wordsBoard().width();
    };
    CrosswordPuzzle.prototype.height = function () {
        return this.wordsBoard().height();
    };
    CrosswordPuzzle.prototype.collisions = function () {
        return this.wordsBoard().overlaps;
    };
    CrosswordPuzzle.prototype.valid = function () {
        return this.wordsBoard().valid;
    };
    CrosswordPuzzle.prototype.possible = function () {
    ...
    CrosswordPuzzle.prototype.addWord = function (word) {
        ...
        if (this.wordsGraph === undefined) {
            ...
            var newPuzzles = (_a = Array.prototype).concat.apply(_a, wordAsChars.map(function (inputWordChar, inputWordCharIndex) {
                return (_this.openLetterCatalog[inputWordChar] || [])
                    .map(function (openLetter, openLetterIndex) {
    ...
    CrosswordPuzzle.prototype.createSubPuzzle = function (word, letterIndex, openLetterIndex) {
        ...
        if (openLetter.overlap(wordOverlapLetter)) {
            newPuzzle.openLetterCatalog[wordOverlapLetter.character] = newPuzzle.openLetterCatalog[wordOverlapLetter.character].filter(function (obj) {
                // Changed this right?
                return obj !== newPuzzle.openLetterCatalog[wordOverlapLetter.character][openLetterIndex];
            });
            return newPuzzle;
        }
        else {
